...
1. We use vanilla JS for popups that are generated by shortcodes! No jQuery, no frameworks, just plain javascript. It means our plugin doesn't rely on frameworks or library such as jQuery. We don't call external scripts, which means the plugin loads a whole lot faster.
...
= 1.1.4 =
The content of popup now has a wrapping container class called 'termscontentwrapper' so that users can style it the way they want.
